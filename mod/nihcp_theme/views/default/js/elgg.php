 ...
 *
 * Overriding the core elgg file in order to point to our own security.js which backports a token refresh bug fix
 * for validating security tokens before refreshing them.
 */
global $CONFIG;
...
$files = array(
    ...
    "$lib_dir/prototypes",
    "$lib_dir/hooks",
    "mod/nihcp_theme/views/default/js/security",
    "$lib_dir/languages",
    "$lib_dir/ajax",
    "$lib_dir/session",
    "$lib_dir/pageowner",
