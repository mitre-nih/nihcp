...
#user-support-button {
 ...
 echo $graphics_folder; ?>button_bg.png) top right repeat-y;
	border-color: #B6B6B6;
	border-style: solid;
...
.user-support-button-help-center {
 ...
 echo $graphics_folder; ?>help_center/helpcenter16_gray.png) no-repeat scroll right bottom;
}
...
.user-support-button-help-center.elgg-state-active {
 ...
 echo $graphics_folder; ?>help_center/helpcenter16.png)
}
