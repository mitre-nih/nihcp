...
return array(
	...
	'item:object:time_spent' => "User Support Time Spent",
...
%s",
    ...
    'user_support:ticket:time_spent' => "For helpdesk administrators, enter the amount of time you have spent on this ticket. Time will be rounded up to the nearest " . UserSupportTimeSpent::TIME_INTERVAL . " minute interval. Recording a new value will overwrite your previous time spent, so put the total time you personally have spent on this specific ticket.",
	'user_support:ticket:time_spent:hours' => "Hours",
    'user_support:ticket:time_spent:minutes' => "Minutes",
	'user_support:ticket:total_time_spent' => "Total Time Spent",
