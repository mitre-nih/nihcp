...
return [
    ...
    'nihcp_commons_credit_request:ccreq:proposed_research:desc' => 'Describe and provide rationale for proposed research. Identify research communities impacted and likely to reuse the results of your research. Attach external document, if this field space is insufficient ' . '(Limit ' . CommonsCreditRequest::PROPOSED_RESEARCH_MAX_LENGTH . ' characters)',
    ...
    'nihcp_commons_credit_request:ccreq:digital_objects:desc' => 'Digital Object Classes such as Datasets, Applications/Tools, or Workflows that may be contributed to the Commons, should the credit be approved and research completed. For each of the following, please enter N/A if not applicable.',
    ...
    'nihcp_commons_credit_request:ccreq:cloud_service_request:desc' => 'Specify the quantity and price for each service selected. The Portal will have input for requested # VMs, RAM, Containers, Compute, etc. Append guide to conformant provider calculators or documentation when available. You may make use of a <a href="' . elgg_get_site_url() . 'nihcp_commons_credit_request/service-request-worksheet">Service Worksheet</a> for estimation, but are not limited to select vendor/s used in making these resource estimates',
